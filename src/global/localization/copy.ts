const copy = {
  ro: {
    ...
    hypothesis_two: `Web-ul ar avea o componentă economică "nativă"?`,
    hypothesis_three: `Protocoalele Web ar garanta securitatea și protecția datelor în mod implicit?`,
